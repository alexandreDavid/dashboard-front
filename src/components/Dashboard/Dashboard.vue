  ...
  <div id="dashboard">
    <div v-if="isLoaded" class="container">
      <div class="row">
        ...
        <DashboardWidget v-if="selectedArea" v-for="(contentObject, key) in dashboard.allContents" :key="key" v-bind:isEditing="isEditing" :contentObject="contentObject" @remove="removeContent(key)" :widgetKey="key" v-bind:selectedArea="selectedArea" v-bind:allParameters="allParameters"></DashboardWidget>
...
export default {
  ...
  async created () {
    ...
    this.isEditing = !(this.dashboard && this.dashboard.allContents && this.dashboard.allContents.length)
    this.isLoaded = true
  },
  methods: {
    ...
    removeContent (index) {
      this.dashboard.allContents.splice(index, 1);
    },
    save () {
